                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white border border-redwood-border p-4 rounded-sm flex gap-4">
                            <div className="relative flex-1">
                                ...
                                <input type="text" placeholder="Search distributors..." className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-sm text-sm focus:outline-none focus:border-redwood-brand" />
                            </div>
                            <div className="flex gap-2">
